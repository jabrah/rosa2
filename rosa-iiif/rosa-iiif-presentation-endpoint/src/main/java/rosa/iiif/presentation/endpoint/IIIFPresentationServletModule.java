...
import rosa.iiif.presentation.core.html.RoseIllustrationHtmlAdapter;
...
public class IIIFPresentationServletModule extends ServletModule {
    ...
    protected void configureServlets() {
        ...
        bind(RoseIllustrationHtmlAdapter.class);
        ...
        adapters.addBinding().to(RoseIllustrationHtmlAdapter.class);
